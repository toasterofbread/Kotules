...
import dev.toastbits.kotules.plugin.mapper.getOutputWrapperClass
...
): KotuleBindingGenerator {
    private val instanceName: String = KotuleGenerationConstants.OUTPUT_BINDING_CONSTRUCTOR_INSTANCE_PARAM_NAME
